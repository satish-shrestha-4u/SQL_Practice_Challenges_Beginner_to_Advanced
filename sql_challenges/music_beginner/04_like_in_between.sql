...
-- When using LIKE, an "_" in the string means "exactly 1 of any character". Otherwise, the rules are the same.
...
-- List songs from artists with id 3, 4, 5 or 6 (Paul McCartney, Adele, David Bowie and Bob Dylan) 
